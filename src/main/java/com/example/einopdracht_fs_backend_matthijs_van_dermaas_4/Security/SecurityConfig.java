...
public class SecurityConfig {
    ...
    public SecurityConfig(JwtService service, UserRepository userRepository, ApplicationContext applicationContext) {
    ...
    @Bean
    public AuthenticationManager authenticationManager(MyUserDetailsService myUserDetailsService, PasswordEncoder passwordEncoder) throws Exception {
