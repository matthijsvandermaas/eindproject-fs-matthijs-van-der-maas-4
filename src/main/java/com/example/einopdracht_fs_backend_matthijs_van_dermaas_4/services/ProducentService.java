...
public class ProducentService {
    ...
    public ProducentDto createProducent(ProducentDto producentDto) {
        ...
        Producent savedProfile = producentRepository.save(producent);

        // Create and return a ProfileDto based on the savedProfile
        ProducentDto savedProfileDto = new ProducentDto();
        producentToProducentDto(savedProfile, savedProfileDto);
